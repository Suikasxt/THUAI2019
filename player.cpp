...
XYPosition land[4] = { {450, 770},{550, 770},{230, 520}, {230, 420} };
//XYPosition land[4] = { {350, 350},{650, 650},{300, 150}, {565, 420} };
...
double ItemValue[21] = {
	0,
	25,//HAND_GUN ÊÖÇ¹
	30,//SUBMACHINE_GUN ³å·æÇ¹
	30,//SEMI_AUTOMATIC_RILE °ë×Ô¶¯²½Ç¹
	35,//ASSAULT_RIFLE Í»»÷²½Ç¹
	35,//MACHINE_GUN »úÇ¹
	30,//SNIPER_RILFE ¾Ñ»÷²½Ç¹
	30,//SNIPER_BARRETT °ÍÀ×ÌØ
	5,//TIGER_BILLOW_HAMMER »¢ÌÎ´¸
	30,//CROSSBOW Ê®×Öåó
	0,//VEST_1
	0,//VEST_2
	0,//VEST_3
...
#ifdef Debug
FILE *OUTPUT = fopen("log4.txt", "w");
FILE *OUTPUT_TMP = fopen("log_4_tmp.txt", "w");
#endif
...
void play_game()
{
	...
	if (!AttackMOD) {
		...
		if (info.self.move_cd == 0) {
			TryToMove(180 + info.self.move_angle + rand()%21 - 10, EnemyAngle);
		}
